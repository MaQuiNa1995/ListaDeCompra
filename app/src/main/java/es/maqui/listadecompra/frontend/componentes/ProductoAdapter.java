...
import es.maqui.listadecompra.frontend.ventanas.CrearListas;
import es.maqui.listadecompra.frontend.ventanas.Main;
...
public class ProductoAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        View rowView = inflater.inflate(R.layout.usar_lista_compra, null);
